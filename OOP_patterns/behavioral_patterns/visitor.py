...
class ConcreteComponentA(Component):
    ...
    def accept(self, visitor: Visitor) -> None:
        """
        Здесь мы вызываем visitConcreteComponentA, что
...
Максимальную выгоду от паттерна Посетитель можно почувствовать, используя его со
сложной структурой объектов, такой как дерево Компоновщика. В этом случае будет полезным
хранить некоторое промежуточное состояние алгоритма при выполнении
